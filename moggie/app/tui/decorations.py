...
DEFAULT_PALETTE = [
            ...
            ('email_key_repl', 'dark gray',   'black',     ''),
            ('email_val_repl', 'light blue',  'black',     ''),
            ('email_cs_repl',  'dark gray',   'black',     ''),
            ...
            ('email_key_bcc',  'dark gray',   'black',     ''),
            ('email_val_bcc',  'dark gray',   'black',     ''),
            ('email_cs_bcc',   'dark gray',   'black',     ''),
            ...
            ('send_sender_p',  'dark gray',   'black',     ''),
            ('send_spacer_p',  'dark gray',   'black',     ''),
            ('send_rcpt_p',    'dark gray',   'black',     ''),
            ('send_status_p',  'dark gray',   'black',     ''),
            ('send_cancel_p',  'dark gray',   'black',     ''),
            ('send_sender_r',  'dark red',    'black',     ''),
            ('send_spacer_r',  'dark gray',   'black',     ''),
            ('send_rcpt_r',    'dark red',    'black',     ''),
            ('send_status_r',  'dark red',    'black',     ''),
            ('send_cancel_r',  'dark gray',   'black',     ''),
            ('send_sender_d',  'yellow',      'black',     ''),
            ('send_spacer_d',  'dark gray',   'black',     ''),
            ('send_rcpt_d',    'yellow',      'black',     ''),
            ('send_status_d',  'yellow',      'black',     ''),
            ('send_cancel_d',  'dark gray',   'black',     ''),
            ('send_sender_c',  'dark red',    'black',     ''),
            ('send_spacer_c',  'dark gray',   'black',     ''),
            ('send_rcpt_c',    'dark red',    'black',     ''),
            ('send_status_c',  'dark red',    'black',     ''),
            ('send_cancel_c',  'dark red',    'black',     ''),
            ('send_sender_s',  'dark green',  'black',     ''),
            ('send_spacer_s',  'dark gray',   'black',     ''),
            ('send_rcpt_s',    'dark green',  'black',     ''),
            ('send_status_s',  'dark green',  'black',     ''),
            ('send_cancel_s',  'dark gray',   'black',     ''),
            ('send_retry_now', 'dark gray',   'black',     ''),
            ('send_plan_title','white',       'black',     ''),
            ('send_hist_title','white',       'black',     ''),
            ('send_hist_date', 'dark gray',   'black',     ''),
            ('send_hist_info', 'white',       'black',     ''),
